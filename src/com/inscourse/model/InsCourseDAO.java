...
public class InsCourseDAO implements InsCourseDAO_interface {
	...
	final String SEARCH_COURSEID = "SELECT * FROM INSCOURSE WHERE COURSEID=?";
	...
	public List<InsCourseVO> findByCourse(String courseId) {
		...
		try {
			con = ds.getConnection();
			pstmt = con.prepareStatement(SEARCH_COURSEID);
	...
	public static void main(String args[]) {
		...
		InsCourseDAO InsCourseJDBCDAO = new InsCourseDAO();
...
//		System.out.println("InscStatus="+InsCourseVO3.getInscStatus());
		...
		//查詢全部
		List<InsCourseVO> list = InsCourseJDBCDAO.findByTeacher("TC00001");
	...
	public List<InsCourseVO> getAll(Integer inscType) {
		...
		try {
			...
			con = ds.getConnection();
			pstmt = con.prepareStatement(SEARCH_ALL_INSCTYPE);
