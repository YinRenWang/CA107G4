  ...
  <c:set var="liveStreamVO" value="${LiveStreamSvc.getLastVideo(teacherVO.teacherId)}" scope="page" />
    <div class="card">
      ...
      <br>
       ...
       <br>
        <br>
        <a href="<%=request.getContextPath()%>/SimpleWebRTC-master/test/selenium/onlyWatch.jsp?${fn:toLowerCase(teacherVO.teacherId)}">
			...
			webSocket.onmessage = function(event) {
				...
				if(data=='open'){
					swal({
						  ...
						  html: '<span class="text"><a href="<%=request.getContextPath()%>/SimpleWebRTC-master/test/selenium/onlyWatch.jsp?tc00005">觀看直播</a></span>'
						});
				}
			};
